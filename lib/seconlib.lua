-- REASON: Dumbass customer put their library in a request and flexed his non existant security and ended up getting it leaked by himself... Ã°Å¸ËœÂ­
...
--It's not the source of moonshine :P
	...
	-- elements 
		...
		function library:window(properties)
			...
			-- theming 
				...
				local watermark = library:watermark({default = os.date('Moonshine |  - %b %d %Y - %H:%M:%S')})  

				task.spawn(function()
					while task.wait(1) do 
						watermark.change_text(os.date('Moonshine - Premium- %b %d %Y - %H:%M:%S'))
					end 
				end) 
            ...
            -- [ESP Preview and Playerlist panels removed by user request]  
		...
		function library:keybind(options)
			...
			-- init 
				...
				-- ok bro its 30 april2025.. what is this code from october 2024 Ã°Å¸â€™â‚¬Ã°Å¸â€™â‚¬
