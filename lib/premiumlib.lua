--hola
    ...
    local Library do
        ...
        local function SafeGetCustomAsset(path)
            ...
            warn("Failed to load asset: " .. tostring(path) .. " Error: " .. tostring(result))
            return ""
        end
        ...
        Library = {
            ...
            Folders = {
                Directory = "moonshinegui",
                Configs = "moonshinegui/Configs",
                Assets = "moonshinegui/Assets"
            },
        ...
        local CustomFont = { } do
            function CustomFont:New(Name, Weight, Style, Data)
                if isfile(Library.Folders.Assets .. "/" .. Name .. ".json") then
                    return Font.new(SafeGetCustomAsset(Library.Folders.Assets .. "/" .. Name .. ".json"))
                end
                ...
                local FontData = {
                    ...
                    faces = { {
                        ...
                        weight = Weight,
                        style = Style,
                        assetId = SafeGetCustomAsset(Library.Folders.Assets .. "/" .. Name .. ".ttf")
                    } }
                }
        ...
        Library.GetImage = function(self, Image)
            ...
            return SafeGetCustomAsset(self.Folders.Assets .. "/" .. ImageData[1])
        end
